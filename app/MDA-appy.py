...
df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/html_data/Transcripts_with_sentiment_topic')
...
html_file2 = read_file('s3grouparmenia/data/html_data/bigrams.html')
...
html_file = read_file('s3grouparmenia/data/html_data/lda.html')
...
map_df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/SDI_data/SDI_map_df.csv')
...
cluster_data = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_with_geo_data+(1)')
...
with col1:
	...
	if but == '1970-1980':
		df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_per_decade/1970-1980.csv')
	...
	if but == '1980-1990':
		df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_per_decade/1980-1990.csv')
	...
	if but == '1990-2000':
		df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_per_decade/1990-2000.csv')
	...
	if but == '2000-2010':
		df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_per_decade/2000-2010.csv')
	...
	if but == '2010-present':
		df = pd.read_csv('https://s3grouparmenia.s3.eu-central-1.amazonaws.com/data/cluster_data/clusters_per_decade/2010-present.csv')
